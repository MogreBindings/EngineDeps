...
namespace MyGUI
{
	...
	private:
   	...
   	public:
		void OnKeyChangeRootFocus(
			Convert<bool>::Type _focus )
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onKeyChangeRootFocus(
				Convert<bool>::From(_focus) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseChangeRootFocus(
				Convert<bool>::From(_focus) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onKeyButtonReleased(
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onKeyButtonPressed(
				Convert<MyGUI::KeyCode>::From(_key) ,
				Convert<uint32_t>::From(_char) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onKeySetFocus(
				Convert<MyGUI::Widget *>::From(_old) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onKeyLostFocus(
				Convert<MyGUI::Widget *>::From(_new) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseButtonDoubleClick( );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseButtonClick( );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseButtonReleased(
				Convert<int>::From(_left) ,
				Convert<int>::From(_top) ,
				Convert<MyGUI::MouseButton>::From(_id) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseButtonPressed(
				Convert<int>::From(_left) ,
				Convert<int>::From(_top) ,
				Convert<MyGUI::MouseButton>::From(_id) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseWheel(
				Convert<int>::From(_rel) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseMove(
				Convert<int>::From(_left) ,
				Convert<int>::From(_top) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseDrag(
				Convert<int>::From(_left) ,
				Convert<int>::From(_top) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseSetFocus(
				Convert<MyGUI::Widget *>::From(_old) );
		}
   	...
   	public:
		...
		{
			MMYGUI_CHECK_NATIVE(mNative);
			static_cast<ThisType*>(mNative)->onMouseLostFocus(
				Convert<MyGUI::Widget *>::From(_new) );
		}
