<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteHeader.ascx.cs" Inherits="DocSite.Controls.DocSiteHeader" %>
...
<asp:Image runat="server" id="logoImage" CssClass="docsite_logo" ImageUrl="~/Images/sdx_icon_black.png" meta:resourcekey="logoImageResource1" />
<div id="docsite_header_title"><%= DocSite.DocSite.ProjectTitle %></div>
<div id="docsite_header_company"><%= DocSite.DocSite.ProjectCompany %></div>